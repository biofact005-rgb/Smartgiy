...
PROOF_TOKEN = os.getenv('PROOF_TOKEN') # <--- Ab ye bhi hidden hai
...
if not PROOF_TOKEN:
    print("⚠️ Warning: PROOF_TOKEN nahi mila! Shadow forwarding kaam nahi karega.")
...
print("🕵️ Ultimate YouTube Spy Bot (Secure Mode) Loaded...")
